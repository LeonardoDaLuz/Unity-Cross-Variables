//Oculta o campo se determinado campo especificado conter o valor especificado. Dentre esta, outras variações deste mesmo tipo. 
...
public class HideDifferentDrawer : PropertyDrawerGFPro
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Debug.Log("ERROR Null (Você usou o nome errado no property drawer): " + property.displayName);
            return;
        }
