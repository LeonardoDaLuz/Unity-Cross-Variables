...
using UnityEngine;
//Excelentissimo pra debug e desenvolvimento, por exemplo, caso queira executar uma função apertando um botão na inspector, isto é util, basta colar o atributo.
