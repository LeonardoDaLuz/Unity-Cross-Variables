/// Printa um objeto, com toda sua hierarquia de classes.
/// d= abreviação de debug, para digitar mais rapido e tb acessivel no CustomInspector
...
public class ObjectDebug {
    ...
    public static void PrintObjectAllDatabase(object obj, int depth=1, bool dumpReferencedClassObjects=false)
    {
	...
	public static string GetObjectAllDatabaseAnTheirReferences(object obj, int depth=5, bool dumpReferencedClassObjects = true)
    {
