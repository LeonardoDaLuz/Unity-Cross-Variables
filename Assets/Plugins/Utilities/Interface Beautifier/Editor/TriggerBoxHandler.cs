...
public class TriggerHandler  {
    ...
    //    if (flipX)
    //    {
    //        bounds.max = new Vector3(-bounds.max.x, bounds.max.y, bounds.max.z);
    //        bounds.min = new Vector3(-bounds.min.x, bounds.min.y, bounds.min.z);
    //        bounds.center = new Vector3(-bounds.center.x, bounds.center.y, bounds.center.z);
    //    }

    //    Handles.DrawLine(RelativeTo + bounds.min, RelativeTo + new Vector3(bounds.min.x, bounds.max.y), color, duration);
    //    Handles.DrawLine(RelativeTo + new Vector3(bounds.min.x, bounds.max.y), RelativeTo + bounds.max, color, duration);
    //    Handles.DrawLine(RelativeTo + bounds.max, RelativeTo + new Vector3(bounds.max.x, bounds.min.y), color, duration);
    //    Handles.DrawLine(RelativeTo + new Vector3(bounds.max.x, bounds.min.y), RelativeTo + bounds.min, color, duration);
    //}
