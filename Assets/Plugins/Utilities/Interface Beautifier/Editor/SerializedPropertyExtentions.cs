...
public static class SerializedPropertyExtensions
{
    ...
    public static bool ArrayIncreaseButton(this SerializedProperty prop, float height = 32f, float width = 32f)
    {
        ...
        if (GUI.Button(buttons, "+"))
        {
            ...
            {
                prop.GetArrayElementAtIndex(i).isExpanded = false;
            }
            prop.arraySize += 1;
    ...
    public static bool ArrayIncreaseButton(this SerializedProperty prop, Type _type, float height = 32f, float width = 32f)
    {
        Rect buttons = EditorGUILayout.GetControlRect(false, height);
        //   buttons.height = 32f;
        //  buttons.y -= 38f;
